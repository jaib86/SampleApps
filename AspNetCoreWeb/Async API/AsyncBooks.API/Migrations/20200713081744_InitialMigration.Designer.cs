...
namespace AsyncBooks.API.Migrations
{
    ...
    [Migration("20200713081744_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AsyncBooks.API.Entities.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("AsyncBooks.API.Entities.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AsyncBooks.API.Entities.Book", b =>
                {
                    b.HasOne("AsyncBooks.API.Entities.Author", "Author")
                        .WithMany()
